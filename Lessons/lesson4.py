# all about numbers
# numeric types are broken down into 3 distinct catagories: int, float, and complex
...
# get the type of on of our values above
print(type(val_int4))
...
# the method below will covert an integer to different numeric stsyem values
print(bin(22))
print(oct(22))
print(hex(22))
